 ...
 *
 * Revision: $Id: jquery.autocomplete.js,v 1.3 2008-12-03 11:43:21 shlomi Exp $
 *
 */
		...
		switch(event.keyCode) {
			...
			case KEY.RETURN:
				if( selectCurrent() ){
					...
					if( !options.multiple )
						//$input.blur(); remarked by yair to leave the focus on the input
					event.preventDefault();
				}
				break;
