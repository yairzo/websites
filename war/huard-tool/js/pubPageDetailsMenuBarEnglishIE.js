...
oCMenu2.makeMenu('top2','','Mark Text','')
  ...
  oCMenu2.makeMenu('top3','','Show Result','','','','','','','','','','','','showResultLTR()')		
	

  oCMenu2.makeMenu('top4','','Structure','','','','','','','','','','','','')	
  	oCMenu2.makeMenu('sub40','top4','Header 1','','','','','','','','','','','','makeSelectionHeader1(accessedInputControl)')
	oCMenu2.makeMenu('sub41','top4','Header 2','','','','','','','','','','','','makeSelectionHeader2(accessedInputControl)')
	oCMenu2.makeMenu('sub42','top4','Header 3','','','','','','','','','','','','makeSelectionHeader3(accessedInputControl)')
	oCMenu2.makeMenu('sub43','top4','Paragraph','','','','','','','','','','','','makeSelectionParagraph(accessedInputControl)')	
...
{
cursorOriginalPosition = accessedInputControl.selectionEnd
accessedInputControl.value = ""+cursorOriginalPosition
originalText = accessedInputControl.value
accessedInputControl.value = accessedInputControl.value.substr(0, accessedInputControl.selectionStart) +
