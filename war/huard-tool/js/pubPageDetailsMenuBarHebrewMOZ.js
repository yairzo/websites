...
oCMenu2.makeMenu('top2','','עצב טקסט','')
  ...
  oCMenu2.makeMenu('top3','','הראה תוצאה','','','','','','','','','','','','showResultRTL()')		
	

  oCMenu2.makeMenu('top4','','מבנה','','','','','','','','','','','','')	
  	oCMenu2.makeMenu('sub40','top4','כותרת1','','','','','','','','','','','','makeSelectionHeader1(accessedInputControl)')
	oCMenu2.makeMenu('sub41','top4','כותרת2','','','','','','','','','','','','makeSelectionHeader2(accessedInputControl)')
	oCMenu2.makeMenu('sub42','top4','כותרת3','','','','','','','','','','','','makeSelectionHeader3(accessedInputControl)')
	oCMenu2.makeMenu('sub43','top4','כותרת4','','','','','','','','','','','','makeSelectionHeader4(accessedInputControl)')
	oCMenu2.makeMenu('sub44','top4','פסקה','','','','','','','','','','','','makeSelectionParagraph(accessedInputControl)')	
