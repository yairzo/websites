        ...
        <section class="section">
			<div class="container clearfix">
				<div class="breadcrumbs clearfix">
					<a href="#">עמוד הבית</a> &rsaquo; <a href="#">אפשרויות מימון</a> &rsaquo; פרטי קול קורא
				</div>
				...
				<div class="content">
					<h1 class="maintitle">קרן אל טיפול פיסול החופשית, ארץ מה ברית תרבות</h1>
					<div class="clearfix mar_20">
						<h2 class="kolkore_date">תאריך הגשה <strong>1.9.2013</strong></h2>
						<div class="clearfix mar_20">
							...
							<div class="kol open">
								...
								<div class="kol_content kol_content_i">
									<p>
										<strong>תאריך הגשה קובע: </strong>1.9.2013<br />
										...
										<strong>קול קורא מקורי: </strong>לא יודעת מה לכתוב כאן</p>
								</div>
							</div>
