...
<div class="side sidelinks">
	...
	<ul>
		<li class="link_research"><a href="/page/<c:choose><c:when test="${lang.rtl}">Research_System_Hebrew</c:when><c:otherwise>Research_System_English</c:otherwise></c:choose>"><fmt:message key="${lang.localeId}.website.researchSystem"/></a></li>
		...
		<li class="link_guidelines"><a href="/page/<c:choose><c:when test="${lang.rtl}">Budgeting_Instruction_Hebrew</c:when><c:otherwise>Budgeting_Instruction_English</c:otherwise></c:choose>"><fmt:message key="${lang.localeId}.website.submissionGuidelines"/></a></li>
		<li class="link_grant"><a href="/page/<c:choose><c:when test="${lang.rtl}">Grants_Guidelines_Hebrew</c:when><c:otherwise>Grants_Guidelines_Hebrew</c:otherwise></c:choose>"><fmt:message key="${lang.localeId}.website.grantGuidelines"/></a></li>
