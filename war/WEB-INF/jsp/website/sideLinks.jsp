...
<div class="side sidelinks">
	...
	<ul>
		...
		<li class="link_budget"><a href="https://www.huji.ac.il/dataj/controller/finance" target="_blank"><fmt:message key="${lang.localeId}.website.personalBudget"/></a></li>
		<li class="link_application"><a href="http://www.yissum.co.il/" target="_blank"><fmt:message key="${lang.localeId}.website.yissum"/></a></li>
	</ul>
</div>
