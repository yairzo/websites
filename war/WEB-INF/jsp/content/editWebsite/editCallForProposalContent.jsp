            ...
            <table border="0" align="center" cellpadding="2" cellspacing="0">
                ...
                <tr class="form">
					<td colspan="4" align="${lang.align}">
						...
						<button class="grey" onclick="window.open('/iws/callForProposal.html?id=${command.id}&t=1','_blank');return false;"><fmt:message key="${lang.localeId}.callForProposal.viewOnSite"/></button>&nbsp;
						</c:if>
						<c:if test="${!online}">
