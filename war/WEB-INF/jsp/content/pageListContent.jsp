		...
		$("#form").submit();
          ...
          <td align="right" bgcolor="#787669" height="20">
          		<c:set var="applicationName" value="ניהול אתר האוניברסיטה"/>
          	        <c:set var="pageName" value="רשימת דפים"/>
          ...
          <td valign="top" align="center"><br>
            <form:form id="form" name="form" method="POST" commandName="command" action="urls.html">
              ...
              <table width="800" border="0" align="center" cellpadding="3" dir="rtl">
                <tr>
                  <td colspan="2" align="center"><h1>רשימת דפים</h1>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
  				   <input class="pageStatus" type="radio" name="pageStatus" class="green" value="0" <c:if test="${pageStatus==0}">checked="checked"</c:if>/>  דפי קולות קוראים
  				   <input class="pageStatus" type="radio" name="pageStatus" class="green" value="1" <c:if test="${pageStatus==1}">checked="checked"</c:if>/>  דפי טקסט 
   				   <input class="pageStatus" type="radio" name="pageStatus" class="green" value="2" <c:if test="${pageStatus==2}">checked="checked"</c:if>/>  כל הדפים
                 </td>
                </tr>
            ...
            <tbody>
  				<tr class="darker">
				<td align="right">
				<a href="callOfProposal.html" target="_blank">255</a>
  				</td>
  				<td align="right">
				<a href="callOfProposal.html" target="_blank">ESF Exploratory Workshops 2008</a>
				</td>
   	  			</tr>
  	  		</tbody>
           ...
           <tbody>
  				<tr class="darker">
				<td align="right">
				<a href="textualPage.html" target="_blank">100</a>
  				</td>
  				<td align="right">
				<a href="textualPage.html" target="_blank">R&D Committees</a>
				</td>
   	  			</tr>
  	  		</tbody>
