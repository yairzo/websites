<%@ page  pageEncoding="UTF-8" %>
          ...
          <td align="right" bgcolor="#787669" height="20">
      	        ...
      	        <c:set var="pageName" value="עריכת הגדרות של טור של רשימה"/>
      ...
      <table width="700" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#767468">
        <tr>
          <td valign="top" align="center"><br>
            <form:form method="POST" action="deleteListColumnInstruction.html" commandName="command">
            	<form:hidden path="id"/>

              <table width="400" border="0" align="center" cellpadding="3" dir="rtl">
                <tr>
                  <td colspan="2" align="center"><h1>מחיקת  הגדרה של טור</h1>
                  </td>
                </tr>
		...
		<tr>
			<th>
				 האם את\ה בטוח\ה שברצונך למחוק את הטור <c:out value="${command.columnName}"/>?
			</th>
		</tr>
