          ...
          <td valign="top" align="center"><br>
			...
			<c:forEach items="${callOfProposals}" var="callOfProposal" varStatus="varStatus">
             <tbody>
				...
				<td align="right">
				<a href="callOfProposal.html?id=${callOfProposal.id}" target="_blank"><c:out value="${callOfProposal.id}"></c:out></a>
  				</td>
  				<td align="right">
				<a href="callOfProposal.html?id=${callOfProposal.id}" target="_blank"><c:out value="${callOfProposal.title}"></c:out></a>
				</td>
   	  			</tr>
  	  		</tbody>
	   		</c:forEach>
