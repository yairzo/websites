...
<div id="popupDialog" title="עזרה" style="display:none" dir="rtl"><p></p></div>
   <tr>
    <td <c:if test="${!iframeView && !print && !noHeader}">background="/image/${website}/bg.jpg" </c:if>>
      <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top" align="center"><c:if test="${(!iframeView || !ajaxView) && !noHeader}"><img src="/image/${website}/header.jpg" width="700" height="97" border="0" useMap="#Map"></c:if></td>
        </tr>
