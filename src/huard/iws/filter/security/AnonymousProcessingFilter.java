...
public class AnonymousProcessingFilter implements Filter, InitializingBean {
	...
	private static final Logger logger = Logger.getLogger(AnonymousProcessingFilter.class);
    ...
    public void saveRequestInSession(HttpServletRequest request){
    	SavedRequest savedRequest = new SavedRequest(request, new PortResolverImpl());
    	if (savedRequest.getFullRequestUrl().indexOf(".html") != -1)
    		request.getSession().setAttribute("ACEGI_SAVED_REQUEST_KEY", savedRequest);
    }
    ...
    throws IOException, ServletException {
    	...
    	saveRequestInSession(httpRequest);
